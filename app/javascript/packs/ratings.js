class Heart_Animation {
    constructor() {
        ...
        this.labels = [
            document.getElementById('heart-label-1'),
            document.getElementById('heart-label-2'),
            document.getElementById('heart-label-3'),
            document.getElementById('heart-label-4'),
            document.getElementById('heart-label-5')
        ];
    ...
    checkFor5Hearts(newRating) {
        if(this.currentRating == 5 && newRating == 5) {
            ...
            this.labels.forEach(element => {
                element.animate([
                    { filter: 'none' },
                    { filter: 'drop-shadow(0 0 10px rgba(250, 135, 135, 0.7))' }
                ], {
                    duration: 150,
                    fill: 'forwards'
                });
